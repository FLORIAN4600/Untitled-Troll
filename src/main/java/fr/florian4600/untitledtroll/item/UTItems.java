...
public class UTItems {
    ...
    public static final Item YIORITE_ORE = new YioriteOreItemBlock(MainClass.YIORITE_ORE, new FabricItemSettings().fireproof().rarity(Rarity.RARE));
    public static final Item DEEPSLATE_YIORITE_ORE = new YioriteOreItemBlock(MainClass.DEEPSLATE_YIORITE_ORE, new FabricItemSettings().fireproof().rarity(Rarity.RARE));
