...
public class UTItemGroups {
    ...
    static {
        UT_GROUP = FabricItemGroup.builder(MainClass.newId("ut_group")).displayName(MainClass.getTranslation("itemgroup", "ut_group")).icon(() -> new ItemStack(MainClass.DEEPSLATE_YIORITE_ORE)).entries((enabledFeatures, entries, operatorEnabled) -> {
